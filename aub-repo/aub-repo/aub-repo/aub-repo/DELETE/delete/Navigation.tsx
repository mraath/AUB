                ...
                <ul className="submenu">
                  <li className="submenu-item">
                    ...
                    <ul className="submenu-top">
                      ...
                      <li className="submenu-top-item">
                        <Link href="/safaris/south-africa/kruger-national-park">
                          Kruger National Park
                        </Link>
                      </li>
                      <li className="submenu-top-item">
                        <Link href="/safaris/south-africa/kruger-national-park/sabi-sand-private-game-reserve">
                          Sabi Sand Reserve
                        </Link>
                      </li>
                      <li className="submenu-top-item">
                        <Link href="/safaris/botswana/okavango-delta">
                          Okavango Delta
                        </Link>
                      </li>
                      <li className="submenu-top-item">
                        <Link href="/safaris/zimbabwe/victoria-falls">
                          Victoria Falls
                        </Link>
                      </li>
                      <li className="submenu-top-item">
                      ...
                      <li className="submenu-top-item">
                        <Link href="/safaris/tanzania/serengeti-national-park">
                          Serengeti
                        </Link>
                      </li>
                      <li className="submenu-top-item">
